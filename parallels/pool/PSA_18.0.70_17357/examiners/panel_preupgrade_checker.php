...
define('PRE_UPGRADE_SCRIPT_VERSION', '18.0.70.0'); //script version
define('PLESK_VERSION', '18.0.70'); // latest Plesk version
...
class Plesk18Requirements
{
    ...
    private function checkDefaultDnsServerComponent()
    {
        ...
        if ('bind' === Util::regQuery($path, $key, true)) {
            ...
            $message = <<<EOL
Updating to Plesk Obsidian 18.0.70 and later is not possible for servers using BIND as the default DNS server.
