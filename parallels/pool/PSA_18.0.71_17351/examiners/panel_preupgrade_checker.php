...
define('PRE_UPGRADE_SCRIPT_VERSION', '18.0.71.0'); //script version
define('PLESK_VERSION', '18.0.71'); // latest Plesk version
...
class Plesk18Requirements
{
    ...
    private function checkDefaultDnsServerComponent()
    {
        ...
        if ('bind' === Util::regQuery($path, $key, true)) {
            ...
            $message = <<<EOL
Updating to Plesk Obsidian 18.0.71 and later is not possible for servers using BIND as the default DNS server.
Learn how to switch from BIND to MSDNS https://support.plesk.com/hc/en-us/articles/13839462553751.
EOL;
            $log->emergency($message);
            $log->resultError();
        }
